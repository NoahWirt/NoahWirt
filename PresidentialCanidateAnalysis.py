...
c = raw_input("Do you support abortion?")
d = raw_input("Have you accepted Jesus as your lord and savior?")
e = raw_input("Are you a \"socialist\" AKA COMMMUNIST?")
f = raw_input("What is your opinion on foreign intervention?")
